...
class Company extends Model
{
    ...
    public static function getHiringCompanies2($counter = 10){
        ...
        return Company::whereIn('id',$companies)->where('name','not like','%sex%')->where('name','not like','%fuck%')->where('name','not like','%http%')->where('name','not like','%adult%')->where('name','not like','%crypto%')->where('name','not like','%free%')->where('name','not like','%$%')->where('name','not like','%dating%')->orderBy('featured','DESC')->orderBy('id','DESC')->get();
    }
