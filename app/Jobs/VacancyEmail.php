...
class VacancyEmail implements ShouldQueue
{
    ...
    public function __construct($recepient, $name, $subject, $caption, $contents,$banner,$template,$attachment1,$attachment2,$attachment3,$sender_address=false,$url=false)
    {
