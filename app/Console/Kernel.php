...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // $schedule->command('command:SendVacancyEmails')->weeklyOn(3, '07:40')->emailOutputOnFailure('david@emploi.co');
        ...
        // $schedule->command('command:SendMassProfileViewedEmail')->weeklyOn(2, '09:00')->emailOutputOnFailure('info@emploi.co');
