...
class Seeker extends Model
{
    ...
    //         if(count($application->interviewResults) > 0)
    //         {
    //             if($application->psychometricScore >= 90)
    //                 $perc += $interview;
    //             elseif($application->psychometricScore >= 70)
    //                 $perc += $interview * 0.8;
    //             elseif($application->psychometricScore >= 60)
    //                 $perc += $interview * 0.6;
    //             elseif($application->psychometricScore >= 40)
    //                 $perc += $interview * 0.3;
    //             else
    //                 $perc += $interview * 0.05;
    //         }
