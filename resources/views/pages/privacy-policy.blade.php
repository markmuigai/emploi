...
<div class="container py-5">
    ...
    <h3 class="pt-3">Google Play Services</h3>
    <h5 class="pt-3">Log Data</h5>
    ...
    <ul>
        ...
        <li>We want to inform users of this Service that these third parties have access to your Personal Information.</li>
    </ul>
    <p>
    ...
    <h5 class="pt-3">Changes to This Privacy Policy
    </h5>
    <p>
        We may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page. These changes are effective
