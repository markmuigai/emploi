...
@section('title','Covid-19 Pandemic Information Series by Emploi')

@section('description')
See how we are supporting companies and individuals in the fight against COVID-19.
@endsection
...
<?php $disableZipFooter = true; ?>
  <section class="w3l-about1" style="opacity: 0.9">
    <div class="new-block top-bottom">
      <div class="container">
        <div class="middle-section">
          <!-- <h5>Tagline</h5> -->
          <div class="section-width">
            <h2>Covid-19 Pandemic Information Series </h2>
          </div>
      ...
      <div class="col-lg-4 mt-5">
        <div class="s-block">
            <div style="border: 2px solid #500095; padding: 10px;">
              ...
              <h3 class="my-3">Job Posting</h3>
              <p class="">Emploi offers its recruitment tools for companies and individuals.<br><br></b></p>
              </a>
            </div>
        </div>
      </div>
