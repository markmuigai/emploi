    ...
    <div class="single">  
	   <div class="form-container row">
        ...
        <div class="search_form1 row">
		    ...
		    <form method="POST" class="col-md-8 col-md-offset-2" action="/employers/applications/{{ $application->post->slug }}/{{ $application->id }}/rsi/interview">
		    	@csrf
		    	<div id="interview-pool">
		    		@forelse($application->interviewResults as $i)
			    	<p>
						<label>Edit Interview Score (0-100) </label><span class="btn btn-sm btn-danger pull-right rm-interview-score">x</span>
				...
				<span id="add-interview" class="btn btn-success btn-sm pull-right">Add Interview</span>
