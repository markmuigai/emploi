...
@section('content')
@section('page_title', 'All About PaaS Dashboard')
                ...
                <div class="card-body">
                    ...
                    Follow the process defined below to use PaaS components fully.
                        <ul>
                            ...
                            <li>Request made is forwarded to all Seekers in the same industry and those interested accept the request.</li>
