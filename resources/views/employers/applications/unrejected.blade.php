...
<ul class="nav nav-tabs" id="allCandidates" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link active"  id="all-candidates-tab"  data-toggle="tab"  href="#" role="tab" aria-controls="all-candidates" aria-selected="true">Not Rejected ({{ count($post->unrejected) }})</a>
    </li>
    <li class="nav-item">
        <a class="nav-link " href="/employers/applications/{{ $post->slug }}/rejected">Rejected ({{ count($post->rejected) }})</a>
    </li>
