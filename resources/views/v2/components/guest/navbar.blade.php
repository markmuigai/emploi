            ...
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        @else
                            <li class="nav-item">
                                <a id="loginButton" href="/v2/login" style="margin-right:0px !important" class="nav-link btn btn-login px-3">{{ __('auth.login') }}</a>
                            </li>
                            <li class="nav-item">
                                <a id="registerButton" href="/v2/join" style="padding-left" class="nav-link btn btn-login btn-orange px-3">{{ __('auth.register') }}</a>
                            </li>
                        @endif
                        @auth
