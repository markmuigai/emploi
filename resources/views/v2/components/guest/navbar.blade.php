                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <a href="/vacancies" class="nav-link dropdown-toggle">Vacancies <i class='bx bx-chevron-down'></i></a>
                        ...
                        @else
                            <li class="nav-item">
                                <a href="/login" class="btn btn-lg btn-login btn-white px-3">{{ __('auth.login') }}</a>
                            </li>
                            <li class="nav-item">
                                <a href="/join" class="btn btn-lg btn-login btn-orange btn-register btn-outline px-3">{{ __('auth.register') }}</a>
                            </li>
                        @endif
                    </ul>
                </div>
