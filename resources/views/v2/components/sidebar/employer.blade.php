...
<div class="nav flex-column nav-pills border rounded" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link {{request()->is('employers/jobs/*') || request()->is('v2/jobs/*') || request()->routeIs('v2.employers*')? 'active' : ''}}" id="v-pills-home-tab"  href="/employers/jobs"  aria-controls="v-pills-home" aria-selected="true">
        <div class="profile-list">
            Jobs
        </div>
    </a>
