...
@section('title','Emploi :: Top Candidates')
...
@section('content')
@section('page_title', 'Top Candidates')

<!-- SEARCH CANDIDATES -->
<form method="get" action="/employers/dashboard/top-candidates">
    <div class="form-row">
