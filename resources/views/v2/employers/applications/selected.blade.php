...
<ul class="nav nav-tabs" id="allCandidates" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/employers/applications/{{ $post->slug }}/shortlisted">Shortlisted ({{ count($post->shortlisted) }})</a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" id="all-candidates-tab"  data-toggle="tab" href="#all-candidates" role="tab" aria-controls="all-candidates" aria-selected="true">Selected ({{ count($post->selected) }})</a>
    </li>
    <li class="nav-item">
            ...
            <div class="card-body text-center">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p>
                        ...
                        <small  title="Role Suitability Index Model">Create Job Score Model to shortlist candidates.</small>
                        @else
                        <small title="Role Suitability Index Model">Edit Job Score Model.</small>
                        @endif
                    </p>
