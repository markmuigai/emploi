...
<ul class="nav nav-tabs" id="allCandidates" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link active"  id="all-candidates-tab"  data-toggle="tab"  href="#" role="tab" aria-controls="all-candidates" aria-selected="true">Rejected ({{ count($post->rejected) }})</a>
    </li>
    ...
    <div class="col-lg-9 col-12">
        ...
        <div class="tab-content pt-2" id="allCandidatesContent">
            ...
            <div class="tab-pane fade show active" id="all-candidates" role="tabpanel" aria-labelledby="all-candidates-tab">
                ...
                @forelse($post->featuredRejectedApplications as $a)
