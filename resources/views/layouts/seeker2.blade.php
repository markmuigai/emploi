    ...
    <a class="navbar-brand" href="/">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent"  style="background-color: #500095; border: none">
        <ul class="navbar-nav mr-auto">
          ...
          @guest
          <li class="nav-item">
            <a class="nav-link" href="/employers/services" style="color: white;">Employers Services</a>
          </li>
          @else
              <li class="nav-item">
...
<section class="w3l-index-block8 py-5">
  <div class="container py-md-3 text-center">
    ...
    <div class="buttons mt-4">
      <a href="/covid19-information-series" class="btn btn-more m-2" style="background-color: #E15419; color:white">Covid Response <span class="fa fa-arrow-right" aria-hidden="true"></span></a>
      <a href="/contact" class="btn m-2" style="background-color: #500095; color:white">Contact Us</a>
      <a href="tel:+254702068282" class="btn m-2" style="background-color: #E15419; color:white;"><i class="fa fa-phone"></i> 0702 068 282</a>
    </div>
  </div>
</section>
<!-- / index-block8 -->
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-md-4 footer-list-28 mt-5">
                      <h6 class="footer-title-28">Emploi</h6>
                      <ul>
                    ...
                    <div class="col-md-4 footer-list-28 mt-5">
                      ...
                      <ul>
                        ...
                        <li><a href="/job-seekers/summit">Summit</a></li>
                        <li><a href="/job-seekers/faqs">FAQs</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
