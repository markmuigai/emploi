                ...
                <div class="col-md-3 d-md-block d-none">
                    <div class="sidebar">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="v-pills-messages-tab" href="/v2/self-assessment?email={{ Auth::user()->email }}" role="tab" aria-controls="v-pills-messages" aria-selected="false">Self Assessment <i class="fas fa-chevron-right"></i></a>
