        ...
        <div class="modal-content p-3">
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-around mt-3 sign-left">
                    ...
                    <a href="{{ $post->shareWhatsappLink }}" data-action="share/whatsapp/share" target="_blank" rel="noreferrer" style="margin-right: 1em"><img src="/images/bg1.jpeg" alt="social share" style="width: 3em"></a>
                </div>
            </div>
        </div>
    </div>
