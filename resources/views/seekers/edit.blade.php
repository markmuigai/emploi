       ...
       <div class="form-container">
        ...
        <form method="POST" action="{{ url('profile/update') }}" enctype="multipart/form-data" id="update-form">
            ...
            <div class="edit-section" id="section1">
                        ...
                        <div class="col-md-9">
                            <select path="country" id="country" name="country" class="form-control input-sm">
                                @foreach($countries as $c)
                                    <option value="{{ $c->id }}"
                                    @if($c->id == $user->seeker->country_id)
                                        selected=""
                                    @endif
                                    >{{ $c->name }}</option>
                                @endforeach
                        ...
                        <div class="col-md-9">
                            <select name="location" class="form-control input-sm">
                                @foreach($locations as $c)
                                    <option value="{{ $c->id }}"
                                    @if($c->id == $user->seeker->location_id)
                                        selected=""
                                    @endif
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-3 control-lable" for="avatar">Profile Photo</label>
                        <div class="col-md-9">
                            <input type="file" name="avatar" id="" class="btn btn-sm" accept=".jpg, .png,.jpeg"/>
                        </div>
                    </div>
                 </div>
            ...
            <div class="edit-section hidden" id="section2">
                        ...
                        <div class="col-md-9">
                            <select id="education_level_id" name="education_level_id" class="form-control input-sm">
                                @foreach($educationLevels as $e)
                                    <option value="{{ $e->id }}"
                                    @if($e->id == $user->seeker->education_level_id)
                                    selected="selected"
                                    @endif
                                    >{{ $e->name }}</option>
                                @endforeach
            ...
            <div class="edit-section hidden" id="section3">
                        ...
                        <div class="col-md-9">
                            <select path="industry" id="industry" name="industry" class="form-control input-sm">
                                @foreach($industries as $c)
                                    <option value="{{ $c->id }}"
                                    @if($c->id == $user->seeker->industry_id)
                                        selected=""
                                    @endif
                                    >{{ $c->name }}</option>
                                @endforeach
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-3 control-lable" for="objective">Career Objective</label>
                        <div class="col-md-9">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-3 control-lable" for="current_position">Current Position</label>
                        <div class="col-md-9">
